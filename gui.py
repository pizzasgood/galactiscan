...
class ResultListCtrl(SortedListCtrl):
    def __init__(self, parent, data):
        ...
        self.InsertColumn(9, 'system x', width=80)
        self.InsertColumn(10,'system y', width=80)
        self.InsertColumn(11,'system z', width=80)
        self.InsertColumn(12,'sector x', width=80)
        self.InsertColumn(13,'sector y', width=80)
        self.InsertColumn(14,'sector z', width=80)
